            ...
            $(_div, { class: classes.sScrollHead })
              ...
              .append(
                $(_div, { class: classes.sScrollHeadInner })
                  ...
                  .append(headerClone.removeAttr("id").css("margin-left", 0).append(table.children("thead")))
              )
        ...
        if (footer) {
          scroller.append(
            $(_div, { class: classes.sScrollFoot })
              ...
              .append($(_div, { class: classes.sScrollFootInner }).append(footerClone.removeAttr("id").css("margin-left", 0).append(table.children("tfoot"))))
        ...
        header: {
          _: function (settings, cell, column, idx, classes) {
            ...
            $(settings.nTable).on("order.dt", function (e, settings, sorting, columns) {
              cell.removeClass(column.sSortingClass + " " + classes.sSortAsc + " " + classes.sSortDesc).addClass(columns[idx] == "asc" ? classes.sSortAsc : columns[idx] == "desc" ? classes.sSortDesc : column.sSortingClass);
            });
          },
          ...
          jqueryui: function (settings, cell, column, idx, classes) {
            ...
            // Attach a sort listener to update on sort
            $(settings.nTable).on("order.dt", function (e, settings, sorting, columns) {
              cell.removeClass(classes.sSortAsc + " " + classes.sSortDesc).addClass(columns[idx] == "asc" ? classes.sSortAsc : columns[idx] == "desc" ? classes.sSortDesc : column.sSortingClass);
              ...
              cell
                ...
                .addClass(columns[idx] == "asc" ? classes.sSortJUIAsc : columns[idx] == "desc" ? classes.sSortJUIDesc : column.sSortingClassJUI);
            });
          },
        },
      });
