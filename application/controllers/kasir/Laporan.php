...
class Laporan extends CI_Controller {
    ...
    // panggil library yang kita buat sebelumnya yang bernama pdfgenerator
        ...
        $html = $this->load->view('kasir/laporan/member',$data, true);
    ...
    // panggil library yang kita buat sebelumnya yang bernama pdfgenerator
        ...
        $html = $this->load->view('kasir/laporan/outlet',$data, true);
    ...
    // panggil library yang kita buat sebelumnya yang bernama pdfgenerator
        ...
        $html = $this->load->view('kasir/laporan/user',$data, true);
    ...
    // panggil library yang kita buat sebelumnya yang bernama pdfgenerator
        ...
        $html = $this->load->view('kasir/laporan/paket',$data, true);
