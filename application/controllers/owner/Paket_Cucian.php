...
class Paket_Cucian extends CI_Controller{
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url() . 'owner/paket/index';
        ...
        $this->load->view('owner/paket/paket',$data);
    ...
    public function tambah()
    {
        ...
        $this->load->view('owner/template/header',$data);
        $this->load->view('owner/paket/tambah_paket',$data);
        $this->load->view('owner/template/footer');
    }
    public function tambah_aksi()
    {
        ...
        if($this->form_validation->run() != true){
            ...
            // halaman di arahkan ke halaman owner paket
            redirect(base_url().'owner/paket_cucian');
    ...
    // kondisi data yang akan di ambil dari database
        ...
        $this->load->view('owner/template/header',$data);
        $this->load->view('owner/paket/edit_paket',$data); // ambil data UI form edit paket
        $this->load->view('owner/template/footer');
    }
    public function aksi_ubah()
    {
        ...
        if($this->form_validation->run() != false){
            ...
            // di arahkan ke halaman owner paket
            redirect(base_url().'owner/paket_cucian');
