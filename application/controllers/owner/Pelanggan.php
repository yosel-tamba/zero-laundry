...
class Pelanggan extends CI_Controller{
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url() . 'owner/pelanggan/index';
        ...
        $this->load->view('owner/pelanggan/member',$data);
    ...
    public function tambah()
    {
        ...
        $this->load->view('owner/template/header',$data);
        $this->load->view('owner/pelanggan/tambah_member');
        $this->load->view('owner/template/footer');
    }
    public function aksi_tambah()
    {
        ...
        if($this->form_validation->run() != true){
            ...
            // halaman di arahkan ke halaman owner member
            redirect(base_url().'owner/pelanggan');
    ...
    public function ubah($id_member) // mengambil data dari button edit
    {
        ...
        $this->load->view('owner/template/header',$data);
        $this->load->view('owner/pelanggan/edit_member',$data); // ambil data UI form edit member
        $this->load->view('owner/template/footer');
    }
    public function aksi_ubah()
    {
        ...
        if($this->form_validation->run() != false){
            ...
            // di arahkan ke halaman owner member
            redirect(base_url().'owner/pelanggan');
