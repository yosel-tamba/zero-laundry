<div class="card">
  ...
  <div class="card-content">
    ...
    <div class="table-responsive">
			<a class="btn btn-primary" href="<?= base_url().'admin/pelanggan/tambah' ?>" role="button">Tambah Data</a>
      <a class="btn btn-success" href="<?= base_url().'admin/laporan/pelanggan' ?>" target="blank" role="button">Buat Laporan</a>
			<br><br>
      <?php
            if(isset($results))
            { ?>
