            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="waves-effect waves-dark active-menu"><i class="fas fa-file-alt"></i> Laporan<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?= base_url('owner/pelanggan'); ?>" class="waves-effect waves-dark active-menu">
                                        <i class="fas fa-users"></i> Pelanggan
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url('owner/pengguna'); ?>" class="waves-effect waves-dark active-menu">
                                    <i class="fas fa-user-cog"></i> Pengguna
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url('owner/paket_cucian'); ?>" class="waves-effect waves-dark active-menu">
                                        <i class="fa fa-box-open"></i> Paket Cucian
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url('owner/outlet'); ?>" class="waves-effect waves-dark active-menu">
                                    <i class="fas fa-store-alt"></i> Outlet 
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url('owner/transaksi'); ?>" class="waves-effect waves-dark active-menu">
