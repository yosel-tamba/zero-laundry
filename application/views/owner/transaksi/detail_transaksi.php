<!-- Main -->
<a class="btn btn-primary" href="<?= base_url().'owner/transaksi' ?>" role="button">kembali</a><br><br>
<div class="card">
    ...
    <div class="card-content">
        ...
        <div class="row">
            <div class="col s115">
                <div class="card-content">
                    <form method="post" action="<?= base_url('owner/transaksi/dt_aksi') ?>" name="detail" enctype="multipart/form-data">
                        ...
                        <div class="col row2 s12">
                            ...
                            <div class="col s4">
                                <label for="id_member" class="black-text" >Pelanggan</label>
                        ...
                        <div class="col row2 s12">
                            ...
                            <div class="col s6">
                                    ...
                                    <select class="" aria-label="Default select example" onfocus="startCalc();" onblur="stopCalc();" name="harga_awal">
                                    <?php foreach($paket as $p) { ?>
                                <option value="<?= $p->harga ?>" <?= $row->harga_awal == $p->harga ? 'selected' : null ?>><?= $p->nama_paket ?> - Rp <?= $p->harga ?></option>
                                <?php } ?>
                                    </select>
                        ...
                        <div class="col row2 s12">
                            ...
                            <div class="row">
                                <div class="col s6">
                                    ...
                                    <input id="biaya_tambahan" type="number" class="validate invalid" name="biaya_tambahan" autocomplete="off" onfocus="startCalc();" onblur="stopCalc();" value="<?= $row->biaya_tambahan; ?>" required>
                                    <?= form_error('biaya_tambahan'); ?>
                                </div>
                                <div class="col s6">
								    <label for="diskon" class="black-text">Diskon <small class="red-text"> * Tanpa %</small> </label>
                                    <input id="diskon" type="number" class="validate invalid" name="diskon"  value="<?= $row->diskon; ?>" onfocus="startCalc();" onblur="stopCalc();" autocomplete="off" required>
                                    <?= form_error('diskon'); ?>
                                </div>
                            </div>
                        <!-- Row 4 -->
                        ...
                        <div class="col s12">
                            <div class="row">
                                <div class="col s6">
                                    ...
                                    <input id="harga" type="number" class="validate bold invalid" name="total_harga" value="<?= $row->total_harga; ?>" onchange="tryNumberFormat(this.form.thirdBox);" autocomplete="off" readonly>
                                    <?= form_error('harga'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            function calc() {
                                harga_awal = document.detail.harga_awal.value;
                                diskon = document.detail.diskon.value;
                                biaya_tambahan = document.detail.biaya_tambahan.value;

                                harga1 = parseInt(harga_awal) + parseInt(biaya_tambahan);
                                harga_diskon = (parseInt(diskon) / 100) * parseInt(harga_awal);
                                
                                document.detail.total_harga.value = parseInt(harga1) - parseInt(harga_diskon);
                            }
                            function stopCalc() {
                    ...
                    <a target="blank" href="<?php echo base_url().'owner/transaksi/print_nota/'.$row->id?>" class="btn btn-sm btn-primary"> Cetak Nota</a>
                    </form>
                </div>
            </div>
        </div>
